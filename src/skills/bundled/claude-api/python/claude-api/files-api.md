...
> **Note:** The Files API is in beta. Reach out through the [feedback form](https://forms.gle/tisHyierGwgN4DUE9) to share your experience.
...
File content used in `Messages` requests are priced as input tokens.
